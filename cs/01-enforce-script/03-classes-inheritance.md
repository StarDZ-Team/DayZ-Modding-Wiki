...
### Vytváření a používání instancí
...
| Modifikátor | Přístupné z | Syntaxe |
|----------|----------------|--------|
...
### Běžné základní třídy pro modding

| Pokud chcete vytvořit... | Rozšiřte... |
|--------------------------|-----------|
| A new item | `ItemBase` |
...
[Domů](../README.md) | [<< Předchozí: Arrays, Maps & Sets](02-arrays-maps-sets.md) | **Classes & Inheritance** | [Další: Modded Classes >>](04-modded-classes.md)
