...
> **Shrnutí:** The `config.cpp` file is the heart of every DayZ mod. It tells the engine what your mod depends on, where your scripts live, what items it defines, and how it integrates with the game. Every PBO must have one. Getting it wrong means your mod silently fails to load.
...
| Závislost | Položka requiredAddons | Kdy použít |
|-----------|---------------------|-------------|
...
### Všechny dostupné skriptové moduly
...
### Definujte pouze to, co používáte
...
## class defs: imageSets a widgetStyles
...
## CfgVehicles: Definice předmětů a entit
...
## CfgSoundSets a CfgSoundShaders
...
## CfgAddons: Deklarace přednačítání
...
**Příznak:** Undefined type errors for classes from the dependency. The mod loaded before the dependency was compiled.
...
**Příznak:** Classes you defined simply do not exist. No error -- they are silently not compiled.
...
**Předchozí:** [Chapter 2.1: The 5-Layer Script Hierarchy](01-five-layers.md)
**Další:** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
