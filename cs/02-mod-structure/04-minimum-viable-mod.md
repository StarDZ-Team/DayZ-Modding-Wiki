...
> **Shrnutí:** This chapter walks you through creating the smallest possible DayZ mod from scratch. By the end, you will have a working mod that prints a message to the script log when the game starts. Three files, zero dependencies, under five minutes.
...
## Krok 4: Vytvořte svůj první skript
...
## Krok 5: Zabalte a otestujte

You have two options for testing:

### Varianta A: File Patching (bez PBO -- pouze pro vývoj)
...
### Varianta B: Balení PBO (vyžadováno pro distribuci)
...
## Krok 6: Ověřte funkčnost

### Nalezení skriptového logu
...
**Předchozí:** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
**Další:** [Chapter 2.5: File Organization Best Practices](05-file-organization.md)
