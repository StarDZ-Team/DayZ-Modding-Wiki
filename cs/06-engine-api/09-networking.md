...
> **Poznámka:** `ScriptInputUserData` has rate limiting. Always check `CanStoreInputUserData()` before sending.
...
[<< Předchozí: File I/O & JSON](08-file-io.md) | **Networking & RPC** | [Další: Central Economy >>](10-central-economy.md)
