...
[<< Předchozí: Module Systems](02-module-systems.md) | [Domů](../README.md) | [Další: Config Persistence >>](04-config-persistence.md)
...
## Zpracování chyb and Notifications
...
**Oprava:** Write a comment block documenting the field order at both the send and receive sites:
...
**Oprava:** Always unregister or clean up handlers on mission finish:
