# Kapitel 2.2: config.cpp Deep Dive

> **Zusammenfassung:** The `config.cpp` file is the heart of every DayZ mod. It tells the engine what your mod depends on, where your scripts live, what items it defines, and how it integrates with the game. Every PBO must have one. Getting it wrong means your mod silently fails to load.
...
**Zurueck:** [Chapter 2.1: The 5-Layer Script Hierarchy](01-five-layers.md)
**Weiter:** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
