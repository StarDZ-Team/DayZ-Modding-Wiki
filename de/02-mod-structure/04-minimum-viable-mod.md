# Kapitel 2.4: Your First Mod -- Minimum Viable

> **Zusammenfassung:** This chapter walks you through creating the smallest possible DayZ mod from scratch. By the end, you will have a working mod that prints a message to the script log when the game starts. Three files, zero dependencies, under five minutes.
