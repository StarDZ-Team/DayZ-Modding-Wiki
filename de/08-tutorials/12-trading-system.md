...
Players press F6 to open a shop menu, browse items by category (Weapons, Food, Medical), and buy/sell using a currency item. Der Server validates every transaction -- der Client never decides prices or spawns items.
...
2. **Delete before spawn.** Remove currency first, then create items. Verhindert duplication.
...
**Vorheriges:** [Chapter 8.11: Clothing Mod](11-clothing-mod.md)
