# Capitulo 4.5: Flujo de Trabajo con DayZ Tools

[<< Anterior: Audio](04-audio.md) | **DayZ Tools** | [Siguiente: PBO Packing >>](06-pbo-packing.md)
...
| Asset Type | File Patching Works? | Notas |
|------------|---------------------|-------|
