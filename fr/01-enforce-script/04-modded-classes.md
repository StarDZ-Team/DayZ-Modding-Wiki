...
**Les classes moddees sont le concept le plus important du modding DayZ.** C'est le mecanisme qui permet a votre mod de modifier le comportement des classes existantes du jeu sans remplacer les fichiers originaux. Sans les classes moddees, le modding DayZ tel que nous le connaissons n'existerait pas.
...
## Comment fonctionnent les classes moddees
...
## Ce que vous pouvez faire dans une classe moddee

### 1. Override Existing Methods

Le plus courant use. Add behavior before or after the vanilla code.
...
## Gardes `#ifdef` pour les dependances optionnelles
...
## Patterns professionnels issus de mods reels
...
- Testez avec other popular mods loaded
...
### Exercice 4: Vehicle Speed Logger
...
### Exercice 5: Optional Mod Integration
...
### The Three Commandments of Classes moddees
