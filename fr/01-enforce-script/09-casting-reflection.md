# Chapter 1.9 — Casting et reflexion
...
> **Avertissement :** `GetClassVar`/`SetClassVar` silently fail if the variable name is wrong or the type doesn't match. Always validate variable names before use.
