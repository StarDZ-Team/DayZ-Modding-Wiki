...
> **Les couches inferieures NE PEUVENT PAS referencer des types des couches superieures.**
...
## Quand le code de chaque couche s'execute
...
C'est le plus courant layer for mod code. Unless your code:
...
**Rappel :** Lower layers cannot see higher layers. When in doubt, use `3_Game`. Move code up only when you need access to types defined in a higher layer.
