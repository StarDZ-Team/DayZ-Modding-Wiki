...
| `FrameWidget` | `FrameWidgetClass` | General-purpose container. Le plus courantly used widget in DayZ. |
...
Le plus courant display widget. Shows a single line of text.
