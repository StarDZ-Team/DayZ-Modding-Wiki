# Chapitre 5.2 : inputs.xml --- Raccourcis clavier personnalises

> **Resume :** The `inputs.xml` file lets your mod register custom keybindings that appear in the player's Controls settings menu. Players can view, rebind, and toggle these inputs just like vanilla actions. C'est le standard mechanism for adding hotkeys to DayZ mods.
