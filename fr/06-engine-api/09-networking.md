...
> **Remarque :** `ScriptInputUserData` has rate limiting. Always check `CanStoreInputUserData()` before sending.
...
For simple state synchronization, `RegisterNetSyncVariable*()` is often simpler than RPCs. Voir [Chapitre 6.1](01-entity-system.md) for details.
