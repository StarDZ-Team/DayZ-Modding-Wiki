...
| `Sort()` / `Sort(true)` | `void` | Croissant / decroissant |
...
*Full documentation: [DayZ Modding Wiki](../README.md) | [Gotchas](01-enforce-script/12-gotchas.md) | [Gestion des erreurs](01-enforce-script/11-error-handling.md)*
