# Chapter 1.2: Tombok, Map-ek es Set-ek
...
### Valos pelda: Finding the Nearest Player
...
**Fontos kulonbseg:** `Insert()` does **not** update existing keys. `Set()` does. When in doubt, use `Set()`.
...
| Gyujtemeny | Tipus | Felhasznalasi terrulet | Fo kulonbseg |
|-----------|------|----------|----------------|
