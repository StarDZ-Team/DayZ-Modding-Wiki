...
| Fogalom | Reszletek |
|---------|---------|
| Szintaxis | `modded class ClassName { }` |
| Hatas | Replaces the original class globally for all `new` calls |
...
### The Three Commandments of Modded osztalyok
