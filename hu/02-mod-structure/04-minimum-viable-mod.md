# Chapter 2.4: Az elso mod -- Minimalis mukodo mod

> **Osszefoglalas:** This chapter walks you through creating the smallest possible DayZ mod from scratch. By the end, you will have a working mod that prints a message to the script log when the game starts. Three files, zero dependencies, under five minutes.
...
- DayZ game installed (retail or DayZ eszkozok/Diag)
- A text editor (VS Code, Notepad++, or any plain text editor)
- DayZ eszkozok installed (for PBO packing) -- OR you can test without packing (see Step 5)
...
### Option B: PBO csomagolas (Required for Distribution)
...
**Elozo:** [Chapter 2.3: mod.cpp es Workshop](03-mod-cpp.md)
**Kovetkezo:** [Chapter 2.5: Fajlszervezes bevalt gyakorlatai](05-file-organization.md)
