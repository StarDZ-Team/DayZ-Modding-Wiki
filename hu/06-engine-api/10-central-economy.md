...
| Parameter | Leiras | Typical Values |
|-----------|-------------|----------------|
...
## Modding the Kozponti gazdasag

### Adding Egyeni targys

1. Define the item class in your mod's `config.cpp` under `CfgJarmuvek`.
