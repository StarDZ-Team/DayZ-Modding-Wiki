...
### CfgJarmuvek Scan Cache

Scanning `CfgJarmuvek` (the global config database of all item/vehicle classes) is expensive. It involves iterating thousands of config entries. Never do it more than once:
...
- [ ] All expensive scans (CfgJarmuvek, entity searches) are cached
