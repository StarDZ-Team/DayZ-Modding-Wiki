# Enforce Script puska (Cheat Sheet)
...
| Metodus | Visszater | Megjegyzesek |
|--------|---------|-------|
...
| Hianyzoo funkcio | Megkerulesi megoldas |
|----------------|------------|
| Ternary `? :` | `if/else` |
...
*Full documentation: [DayZ Modding Wiki](../README.md) | [Gotchas](01-enforce-script/12-gotchas.md) | [Hibakezelees](01-enforce-script/11-error-handling.md)*
