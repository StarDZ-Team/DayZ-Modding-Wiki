...
2. You **cannot** use a variable as the size: `int arr[myVar]` is a errore di compilazione
3. Accessing an out-of-bounds index causes undefined comportamento (no runtime bounds check)
...
Dovrai encounter `TStringArray` constantly in DayZ code --- config parsing, chat messages, loot tables, and more.
...
### 5. Modifying a Collezione During foreach
...
3. Rimuovi tutto players with zero kills
...
[Home](../../it/README.md) | [<< Previous: Variables & Types](01-variables-types.md) | **Arrays, Maps & Sets** | [Next: Classes & Inheritance >>](03-classes-inheritance.md)
