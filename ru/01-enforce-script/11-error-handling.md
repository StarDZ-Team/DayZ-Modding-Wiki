...
## ErrorEx — отчёты об ошибках движка
...
## DumpStackString — трассировки стека
...
### Безопасная функция с множеством проверок
