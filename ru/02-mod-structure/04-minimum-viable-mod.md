...
> **Итоги:** Эта глава проведёт вас через создание минимально возможного мода DayZ с нуля. К концу у вас будет работающий мод, который выводит сообщение в лог скриптов при запуске игры. Три файла, ноль зависимостей, менее пяти минут.
...
## Шаг 4: Создайте свой первый скрипт
...
## Шаг 5: Упакуйте и протестируйте
...
**Предыдущая:** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
**Следующая:** [Chapter 2.5: File Organization Best Practices](05-file-organization.md)
