...
## Моды с разделением клиент-сервер
...
**Предыдущая:** [Chapter 2.4: Your First Mod -- Minimum Viable](04-minimum-viable-mod.md)
**Следующая:** [Part 3: GUI & Layout System](../03-gui-system/01-widget-types.md)
