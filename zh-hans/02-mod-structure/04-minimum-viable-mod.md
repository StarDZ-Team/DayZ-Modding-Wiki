...
上级date `config.cpp` to include the new layer:
...
**上一章：** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
**下一章：** [Chapter 2.5: File Organization Best Practices](05-file-organization.md)
