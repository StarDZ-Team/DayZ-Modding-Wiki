...
This is called automatically by the vanilla mission's `On上级date` method. If you are writing a completely custom mission, make sure to call it.
...
[<< 上一章: Post-Process Effects](05-ppe.md) | **Notifications** | [下一章: Timers & CallQueue >>](07-timers.md)
