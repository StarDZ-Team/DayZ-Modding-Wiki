...
> **注意：** `ScriptInputUserData` has rate limiting. Always check `CanStoreInputUserData()` before sending.
...
[<< 上一章: File I/O & JSON](08-file-io.md) | **Networking & RPC** | [下一章: Central Economy >>](10-central-economy.md)
