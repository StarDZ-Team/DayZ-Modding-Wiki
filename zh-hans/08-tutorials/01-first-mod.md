...
> **摘要：** This tutorial walks you through creating your very first DayZ mod from absolute zero. You will install the tools, set up your workspace, write three files, pack a PBO, load the mod in DayZ, and verify it works by reading the script log. No prior DayZ modding experience required.
...
- [Step 2: Set 上级 the P: Drive (Workdrive)](#step-2-set-up-the-p-drive-workdrive)
...
## Step 2: Set 上级 the P: Drive (Workdrive)
...
### Set 上级 the Final Mod Structure
...
**下一章：** [Chapter 8.2: Creating a Custom Item](02-custom-item.md)
