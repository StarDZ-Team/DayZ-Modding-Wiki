...
Profiling data gathering is not enabled 默认情况下. This toggle shows whether it is currently active.
...
| 标志 Combination | Scope | Data Lifetime |
|-----------------|-------|---------------|
...
> **Warning:** Max. Collider Distance is 0 默认情况下 because this visualization is expensive. Setting it to a large distance will cause significant performance degradation.
...
3. **Debug Path Agent** -- 参见 actual path an AI is taking and whether pathfinding succeeds
