# 第 2.2 章：config.cpp 深入解析

> **摘要：** The `config.cpp` file is the heart of every DayZ mod. It tells the engine what your mod depends on, where your scripts live, what items it defines, and how it integrates with the game. Every PBO must have one. Getting it wrong means your mod silently fails to load.
...
## class defs：imageSets 和 widgetStyles
...
## CfgSoundSets 和 CfgSoundShaders
...
**症状：** Undefined type errors for classes from the dependency. The mod loaded before the dependency was compiled.
...
**症状：** Classes you defined simply do not exist. No error -- they are silently not compiled.
...
**上一章：** [Chapter 2.1: The 5-Layer Script Hierarchy](01-five-layers.md)
**下一章：** [Chapter 2.3: mod.cpp & Workshop](03-mod-cpp.md)
