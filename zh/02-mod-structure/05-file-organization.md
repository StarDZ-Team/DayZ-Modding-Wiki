...
> **摘要：** How you organize files determines whether your mod is maintainable at 10 files or 1,000. This chapter covers the canonical directory structure, naming conventions, content vs script vs framework mods, client-server splits, and lessons from professional DayZ mods.
...
**修复：** One file per class, organized in subdirectories by subsystem.
...
**修复：** Follow the layer rules from Chapter 2.1. Move entity code to `4_World` and UI code to `5_Mission`.
...
**修复：** Always namespace with a subdirectory:
...
**修复：** `stringtable.csv` goes at the mod root (next to `mod.cpp`):
...
**修复：** Separate into multiple PBOs:
...
**修复：** Keep nesting to 2-3 levels maximum. Flatten when possible:
...
**修复：** Pick one convention and stick with it:
...
**上一章：** [Chapter 2.4: Your First Mod -- Minimum Viable](04-minimum-viable-mod.md)
