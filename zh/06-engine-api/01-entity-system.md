...
[Home](../../README.md) | **Entity System** | [下一章: Vehicles >>](02-vehicles.md)
...
| `GetSibling` | `proto native IEntity GetSibling()` | 下一章 sibling entity |
...
| `ECE_UPDATEPATHGRAPH` | `32` | 上级date navigation mesh |
