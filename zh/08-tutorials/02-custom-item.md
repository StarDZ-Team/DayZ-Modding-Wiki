...
> **摘要：** This tutorial walks you through adding a brand-new item to DayZ. You will define the item in config.cpp, give it textures using hidden selections, add it to the server's spawn table, create a string table for its display name, and test it in-game. By the end, you will have a custom item that players can find, pick up, and carry in their inventory.
...
- [Step 2: Set 上级 Hidden Selections for Textures](#step-2-set-up-hidden-selections-for-textures)
...
## Step 2: Set 上级 Hidden Selections for Textures
...
### 上级date Your Scripts config.cpp
...
上级date `Scripts/config.cpp` to include the new layer:
...
**上一章：** [Chapter 8.1: Your First Mod (Hello World)](01-first-mod.md)
**下一章：** [Chapter 8.3: Building an Admin Panel Module](03-admin-panel.md)
