...
- [Step 7: 上级date the UI with Received Data](#step-7-update-the-ui-with-received-data)
...
## Step 7: 上级date the UI with Received Data
...
### UI Shows But Data Does Not 上级date
...
**上一章：** [Chapter 8.2: Creating a Custom Item](02-custom-item.md)
**下一章：** [Chapter 8.4: Adding Chat Commands](04-chat-commands.md)
